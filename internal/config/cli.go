...
func Load() (*Config, error) {
	...
	parseOnly := flag.Bool("parse-only", false, "Run extraction and planning only; skip GitHub integration")
	...
	flag.Usage = func() {
		...
		flags := []struct {
			...
			{"--parse-only", "", "Run extraction and planning only; skip GitHub integration"},
